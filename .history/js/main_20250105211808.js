...
function kpop() {
  ...
  animation
    ...
    .to(firstMapLine, {
      strokeDashoffset: 0,
      duration: 5,
      opacity: 1, // 선이 나타날 때 opacity를 1로 설정
    })
    .to(secondMapLine, {
      strokeDashoffset: 0,
      duration: 5,
  ...
  const timeline2 = gsap.timeline({
    scrollTrigger: {
      trigger: '#about_wrap',  // 두 번째 트리거는 #about_wrap
      start: 'top center',
      end: 'bottom top',
      scrub: true,
      markers: false,
  ...
  const timeline3 = gsap.timeline({
    scrollTrigger: {
      trigger: '#global_header',  // 세 번째 트리거는 #global_header
      start: 'top center',
      end: 'bottom top',
      scrub: true,
      markers: false,

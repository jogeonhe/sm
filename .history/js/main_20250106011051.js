...
function kpop() {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    // 각 타임라인 생성
    const animation1 = createAnimation1();
    const animation2 = createAnimation2();
    const animation3 = createAnimation3();
    const animation4 = createAnimation4();
  });
  ...
  function createAnimation4() {
    ...
    animation4.to([svgWrap, aboutText, about], {
      y: -400,
      opacity: 0,
      duration: 30
    })

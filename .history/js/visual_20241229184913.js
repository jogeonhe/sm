...
function visualEffect(){
   ...
   function slideNext(){
    ...
    gsap.set(galleryLi[nextIndex], {left: visualWidth, opacity:0 ,});
    gsap.to(galleryLi[currentIndex], {left:-visualWidth, opacity:0,duration:0.8, ease:'power1.out'})
    gsap.to(galleryLi[nextIndex], {left:0, opacity:1,duration:0.8, ease:'power1.out',onComplete:()=>{

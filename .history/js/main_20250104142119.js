document.addEventListener('DOMContentLoaded', () => {
  ...
  gsap.to(about, {
    ...
    scrollTrigger: {
      trigger: aboutWrap,
      start: '90% 0',     // aboutWrap이 화면의 90% 지점에 오면 애니메이션 시작
      end: 'bottom top',  // aboutWrap이 화면의 아래 끝에 도달하면 애니메이션 종료
      toggleActions: 'play reverse play reverse', // 내리면 실행, 올리면 반대로
    }
  });
  ...
  gsap.to(aboutText, {
    ...
    scrollTrigger: {
      trigger: aboutWrap,
      start: '90% 0',     // aboutText의 애니메이션도 동일하게 시작 지점 설정
      end: 'bottom top',  // aboutText의 애니메이션도 종료 지점 설정
      toggleActions: 'play reverse play reverse', // 내리면 실행, 올리면 반대로
    }
  });
